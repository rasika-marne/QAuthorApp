...
- (id)init {
  ...
  if (self = [super initWithFrame:CGRectZero]) {
	...
	UIImage* closeImagePressed = [UIImage imageNamed:@"facebookOverlayClose.png"];
	...
	[_closeButton setImage:closeImagePressed forState:UIControlStateHighlighted];
...
- (void)drawRect:(CGRect)rect {
  ...
  [self drawRect:grayRect fill:kBorderGray radius:10.0f];
  ...
  [self drawRect:headerRect fill:kFacebookBlue radius:0.0f];
      ...
      if (errorCode) {
        ...
        [self dismissWithError:error animated:YES];
		  UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"alert"
														  message:@"Please logout and relogin to use Facebook share."
														 delegate:nil 
...
- (id)initWithURL: (NSString *) serverURL params: (NSMutableDictionary *) params
